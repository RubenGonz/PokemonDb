<%@page contentType="text/html" pageEncoding="UTF-8" %>
    ...
    <body>
        ...
        <main>
          ...
          <form method="post">
            <a href="ModificarPokemon.jsp"><input class="boton" type="button" value="Modificar pokemon"></a>
            <a href="ModificarEntrenador.jsp"><input class="boton" type="button" value="Modificar entrenador"></a>
            <a href="ModificarObjeto.jsp"><input class="boton" type="button" value="Modificar objeto"></a>
            <a href="ModificarMovimiento.jsp"><input class="boton" type="button" value="Modificar movimiento"></a>
          </form>
            </section>
