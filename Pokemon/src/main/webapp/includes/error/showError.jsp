            ...
            <body>
                ...
                <main>
                    ...
                    <section>
                        <form method="post">
                            <div>
                                Ha ocurrido un problema con la pokeAplicación:
                            </div>
                            <div>
                                <% UsuarioException e=(UsuarioException) exception; String message=e.getMessage(); %>
                                <%=message %>
                            </div>
                            <div>Puede volver al menu de la aplicación pulsando en el icono de PokemonDb</div>        
                        </form>
                    </section>
                </main>
