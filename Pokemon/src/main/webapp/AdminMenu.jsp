<%@page contentType="text/html" pageEncoding="UTF-8" %>
    ...
    <body>
        ...
        <main>
          ...
          <form method="post">
            <a href="Insertar.jsp"><input class="boton" type="button" value="Insertar"></a>
            <a href="Eliminar.jsp"><input class="boton" type="button" value="Eliminar"></a>
            <a href="Modificar.jsp"><input class="boton" type="button" value="Modificar "></a>
