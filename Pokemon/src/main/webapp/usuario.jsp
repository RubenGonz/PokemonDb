<%@page contentType="text/html" pageEncoding="UTF-8" %>
  ...
  <body>
    <header>
      <div class="logo">
        <a href="index.jsp"><img src="https://fontmeme.com/permalink/210610/42500246a9232da5b50e573f025bfa81.png"
    ...
    <main>
      ...
      <section class="formulario">
        ...
        <div class="mainFormulario">
          <form method="post">
            <a href="buscarPokemon.jsp"><input class="boton" type="button" value="Buscar pokemon"></a>
            <a href="buscarEntrenador.jsp"><input class="boton" type="button" value="Buscar entrenador"></a>
            <a href="buscarObjeto.jsp"><input class="boton" type="button" value="Buscar objeto"></a>
            <a href="buscarMovimiento.jsp"><input class="boton" type="button" value="Buscar movimiento"></a>
          </form>
        </div>
      </section>
      ...
      <div>
        ...
        <div class="contribuidores">
          <div class="enlacesFooter">
            ...
            <div>
              <a href="https://github.com/RubenGonz"><img src="./Imagenes/IconoGitHub.png" alt="Icono de github"></a>
              <a href="https://github.com/RubenGonz">RubenGonz</a>
            </div>
            <div>
              <a href="https://www.facebook.com/profile.php?id=100011142169001"><img src="./Imagenes/IconoFacebook.png"
