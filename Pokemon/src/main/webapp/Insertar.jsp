<%@page contentType="text/html" pageEncoding="UTF-8" %>
    ...
    <body>
        ...
        <main>
          ...
          <form method="post">
            <a href="InsertarPokemon.jsp"><input class="boton" type="button" value="Insertar pokemon"></a>
            <a href="InsertarEntrenador.jsp"><input class="boton" type="button" value="Insertar entrenador"></a>
            <a href="InsertarObjeto.jsp"><input class="boton" type="button" value="Insertar objeto"></a>
            <a href="InsertarMovimiento.jsp"><input class="boton" type="button" value="Insertar movimiento"></a>
          </form>
            </section>
