<%@page contentType="text/html" pageEncoding="UTF-8" %>
    ...
    <body>
        ...
        <main>
          ...
          <form method="post">
            <a href="EliminarPokemon.jsp"><input class="boton" type="button" value="Eliminar pokemon"></a>
            <a href="EliminarEntrenador.jsp"><input class="boton" type="button" value="Eliminar entrenador"></a>
            <a href="EliminarObjeto.jsp"><input class="boton" type="button" value="Eliminar objeto"></a>
            <a href="EliminarMovimiento.jsp"><input class="boton" type="button" value="Eliminar movimiento"></a>
          </form>
            </section>
